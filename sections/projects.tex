...
% {Airline Operational Efficiency Optimization}{Dec 2024 -- Feb 2025}
%   \vspace{-10pt}
% \resumeItemListStart
%     \resumeItemNoTitle{Developed and deployed optimization models using Linear Programming (LP) and Mixed Integer Programming (MIP) techniques to simulate airline scheduling and resource allocation}
%     \resumeItemNoTitle{Built predictive analytics tools using historical flight data (FlightAware) to minimize delays and optimize turnaround times, demonstrating potential efficiency improvements of up to 15\% and created interactive operational Tableau reports}
% \resumeItemListEnd
\resumeSubheadingProject
